...
module.exports = {
  ...
  async execute(message, args) {
    ...
    const requiredVC = new MessageEmbed()
     ...
     // .setTitle("Error!")
      .setDescription("<:Zayn_salah:841625444594876417>・Please join a voice channel before using this command");
    ...
    //  .setTitle("Play")
      .setDescription(
        `<:Zayn_salah:841625444594876417>・Usage : ${message.client.prefix}play **Song Title** | **YouTube URL** | **Spotify Song Link** | **Soundcloud URL**`
      );
    ...
    if (!permissions.has("CONNECT")) {
      ...
      //  .setTimestamp()
        ...
        .setDescription(
          "<:Zayn_salah:841625444594876417>・Cannot connect to the voice channel, Missing Permissions"
        );
    ...
    const addedSongToQueue = new MessageEmbed()
      ...
      .setColor(message.guild.me.displayHexColor)
     // .setTitle("Queued")
      .setDescription(`<a:Zayn_centang:841289776379461702>・Succes added **[${song.title}](${song.url})** to queue.`);
